...
- Core claims about theological foundations.
- Supporting claims about practices, affections, habits, or formation.
- Biblical basis nodes where Scripture is functioning as grounding.
- Historical example nodes where older figures, movements, or traditions are being retrieved or illustrated.
...
- `ch01-cc001` for `core_claim`.
- `ch01-sc001` for `supporting_claim`.
- `ch01-bb001` for `biblical_basis`.
- `ch01-he001` for `historical_example`.
